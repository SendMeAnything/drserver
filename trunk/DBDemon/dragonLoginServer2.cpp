...
void RecvGmRegist( t_packet *p )
{
	...
	sprintf( condition, "job = %d AND name = '%s'", gm_list, name );		// °°Àº Á÷Á¾À¸·Î ¶È°°Àº ³ðÀÌ ÀúÀåµÇ´Â°É ¸·±â À§ÇØ
...
void RecvRegistGuild_DB( t_packet *p, short int cn )
{
	...
	char *guild_name = p->u.kein.regist_guild_imsi_db.guild_name;
