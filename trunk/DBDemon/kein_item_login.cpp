...
/////////////////////////////////////////////////////////////////////////////
	CItem_Plant::use(int t, t_chr_status_info *p, POS s, POS d ) { return 0; }
	CItem_Mineral::use(int t, t_chr_status_info *p, POS s, POS d ) { return 0; }
	CItem_Herb::use(int t, t_chr_status_info *p, POS s, POS d ) { return 0; }
	CItem_Cook::use(int t, t_chr_status_info *p, POS s, POS d ) { return 0; }
	CItem_Potion::use(int t, t_chr_status_info *p, POS s, POS d ) { return 0; }
	CItem_Tool::unequip(int,struct chr_status_info *,struct t_POS,struct t_POS)		 { return 0; }
	CItem_Tool::is_equipable(int,struct chr_status_info *,struct t_POS,struct t_POS) { return 0; }
	CItem_Weapon::unequip(int,struct chr_status_info *,struct t_POS,struct t_POS)	 { return 0; }
	CItem_Weapon::is_equipable(int,struct chr_status_info *,struct t_POS,struct t_POS) { return 0; }
	CItem_Disposable::unequip(int,struct chr_status_info *,struct t_POS,struct t_POS) { return 0; }
	CItem_Disposable::is_equipable(int,struct chr_status_info *,struct t_POS,struct t_POS) { return 0; }
	CItem_Armor::unequip(int,struct chr_status_info *,struct t_POS,struct t_POS) { return 0; }
	CItem_Armor::is_equipable(int,struct chr_status_info *,struct t_POS,struct t_POS) { return 0; }
	CItem_Accessory::unequip(int,struct chr_status_info *,struct t_POS,struct t_POS) { return 0; }
	CItem_Accessory::is_equipable(int,struct chr_status_info *,struct t_POS,struct t_POS) { return 0; }
	CItem_Etc::unequip(int,struct chr_status_info *,struct t_POS,struct t_POS) { return 0; }
	CItem_Etc::is_equipable(int,struct chr_status_info *,struct t_POS,struct t_POS) { return 0; }
	CItem_Plant::EatItem(CHARLIST *ch )	{ return 0; }
	CItem_Herb::EatItem(CHARLIST *ch )	{ return 0; }
	CItem_Herb::UseItem(CHARLIST *ch )	{ return 0; }
	CItem_Cook::EatItem(CHARLIST *ch )	{ return 0; }
	CItem_Cook::UseItem(CHARLIST *ch )	{ return 0; }
	CItem_Potion::EatItem(CHARLIST *ch )	{ return 0; }
	CItem_Potion::UseItem(CHARLIST *ch )	{ return 0; }
	CItem_Potion::is_equipable(int,struct chr_status_info *,struct t_POS,struct t_POS) { return 0; }
	CItem_Weapon::ReleaseItem(struct tagCHARLIST *) { return 0; }

	CItem_Weapon::CurrEquip(struct tagCHARLIST *)			{ return 0; }
	CItem_Weapon::EquipItem(struct tagCHARLIST *)			{ return 0; }
	CItem_Armor::ReleaseItem(struct tagCHARLIST *)			{ return 0; }
	CItem_Armor::CurrEquip(struct tagCHARLIST *)			{ return 0; }
	CItem_Armor::EquipItem(struct tagCHARLIST *)			{ return 0; }
	CItem_Accessory::ReleaseItem(struct tagCHARLIST *)		{ return 0; }
	CItem_Accessory::CurrEquip(struct tagCHARLIST *)		{ return 0; }
	CItem_Accessory::EquipItem(struct tagCHARLIST *)		{ return 0; }
	CItem_Etc::ReleaseItem(struct tagCHARLIST *)			{ return 0; }
	CItem_Etc::CurrEquip(struct tagCHARLIST *)				{ return 0; }
	CItem_Etc::EquipItem(struct tagCHARLIST *)				{ return 0; }
